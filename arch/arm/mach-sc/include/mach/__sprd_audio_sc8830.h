...
extern sci_get_couter4pmu_apb_sleep_ctrl();
...
#endif
	printk("couter4pmu_apb_sleep_ctrl in arch_audio_sleep_xtl_enable is %d\n\r",sci_get_couter4pmu_apb_sleep_ctrl());
	return 0;
}
...
#endif
	printk("couter4pmu_apb_sleep_ctrl in arch_audio_sleep_xtl_disable is %d\n\r",sci_get_couter4pmu_apb_sleep_ctrl());
	return 0;
}
